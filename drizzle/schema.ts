...
export const embaixadores = pgTable("embaixadores", {
  ...
  cep: text("cep"),
  pais: text("pais"),
  programasParticipou: text("programasParticipou"),
  aberturasPaises: text("aberturasPaises"),
  dataEmbaixador: text("dataEmbaixador"),
  sedeLegendario: text("sedeLegendario"),
  cargoLideranca: text("cargoLideranca"),
  doacaoPoco: text("doacaoPoco"),
  numeroAnel: text("numeroAnel"),
  temJaqueta: text("temJaqueta"),
  temPin: text("temPin"),
  temPatch: text("temPatch"),
  temEspada: text("temEspada"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
});
